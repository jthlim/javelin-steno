...
const JeffPhrasingEnder *const ENDER_HASH_MAP[] = {
    nullptr,      nullptr,      ENDERS + 119, nullptr,      ENDERS + 148,
    nullptr,      nullptr,      ENDERS + 136, ENDERS + 67,  nullptr,
    ENDERS + 118, ENDERS + 115, ENDERS + 146, ENDERS + 19,  nullptr,
    ENDERS + 134, ENDERS + 54,  ENDERS + 180, nullptr,      nullptr,
    nullptr,      ENDERS + 176, ENDERS + 108, nullptr,      ENDERS + 52,
    ENDERS + 178, nullptr,      ENDERS + 16,  nullptr,      ENDERS + 174,
    ENDERS + 106, nullptr,      nullptr,      nullptr,      nullptr,
    nullptr,      nullptr,      nullptr,      nullptr,      nullptr,
    nullptr,      nullptr,      nullptr,      nullptr,      nullptr,
    nullptr,      nullptr,      nullptr,      ENDERS + 101, nullptr,
    nullptr,      ENDERS + 195, nullptr,      ENDERS + 105, ENDERS + 185,
    nullptr,      ENDERS + 99,  ENDERS + 95,  ENDERS + 161, ENDERS + 193,
    nullptr,      ENDERS + 103, ENDERS + 183, nullptr,      nullptr,
    ENDERS + 48,  nullptr,      nullptr,      ENDERS + 84,  nullptr,
    nullptr,      ENDERS + 156, ENDERS + 151, ENDERS + 46,  nullptr,
    nullptr,      ENDERS + 82,  nullptr,      nullptr,      ENDERS + 154,
    ENDERS + 122, nullptr,      nullptr,      ENDERS + 40,  nullptr,
    ENDERS + 6,   ENDERS + 164, nullptr,      ENDERS + 120, nullptr,
    nullptr,      ENDERS + 38,  nullptr,      ENDERS + 4,   ENDERS + 132,
    nullptr,      ENDERS + 37,  nullptr,      nullptr,      ENDERS + 191,
    nullptr,      nullptr,      ENDERS + 33,  nullptr,      nullptr,
    nullptr,      nullptr,      nullptr,      nullptr,      nullptr,
    nullptr,      nullptr,      nullptr,      nullptr,      nullptr,
    ENDERS + 169, nullptr,      ENDERS + 15,  ENDERS + 171, nullptr,
    nullptr,      nullptr,      nullptr,      ENDERS + 167, nullptr,
    ENDERS + 13,  ENDERS + 145, nullptr,      nullptr,      nullptr,
    nullptr,      nullptr,      nullptr,      ENDERS + 172, nullptr,
    nullptr,      ENDERS + 76,  nullptr,      ENDERS + 143, nullptr,
    nullptr,      ENDERS + 128, ENDERS + 152, nullptr,      nullptr,
    ENDERS + 194, ENDERS + 100, nullptr,      ENDERS + 184, nullptr,
    nullptr,      ENDERS + 104, ENDERS + 160, ENDERS + 192, ENDERS + 98,
    ENDERS + 94,  ENDERS + 182, nullptr,      nullptr,      ENDERS + 102,
    nullptr,      nullptr,      ENDERS + 69,  nullptr,      nullptr,
    nullptr,      nullptr,      nullptr,      nullptr,      nullptr,
    nullptr,      nullptr,      nullptr,      nullptr,      nullptr,
    nullptr,      nullptr,      nullptr,      ENDERS + 55,  ENDERS + 181,
    ENDERS + 109, nullptr,      nullptr,      ENDERS + 177, nullptr,
    ENDERS + 17,  ENDERS + 53,  ENDERS + 179, ENDERS + 107, nullptr,
    nullptr,      ENDERS + 175, nullptr,      nullptr,      nullptr,
    nullptr,      nullptr,      ENDERS + 126, nullptr,      nullptr,
    ENDERS + 186, ENDERS + 189, ENDERS + 89,  nullptr,      ENDERS + 31,
    ENDERS + 124, nullptr,      nullptr,      nullptr,      ENDERS + 168,
    nullptr,      nullptr,      ENDERS + 170, nullptr,      nullptr,
    ENDERS + 14,  nullptr,      ENDERS + 166, nullptr,      nullptr,
    ENDERS + 144, nullptr,      nullptr,      ENDERS + 12,  nullptr,
    nullptr,      ENDERS + 61,  nullptr,      nullptr,      nullptr,
    nullptr,      nullptr,      nullptr,      nullptr,      nullptr,
    nullptr,      nullptr,      nullptr,      nullptr,      nullptr,
    nullptr,      ENDERS + 41,  ENDERS + 123, nullptr,      ENDERS + 165,
    nullptr,      nullptr,      ENDERS + 7,   nullptr,      ENDERS + 39,
    ENDERS + 121, nullptr,      ENDERS + 133, nullptr,      nullptr,
    ENDERS + 5,   nullptr,      nullptr,      nullptr,      nullptr,
    nullptr,      ENDERS + 68,  nullptr,      nullptr,      ENDERS + 18,
    ENDERS + 147, ENDERS + 135, nullptr,      nullptr,      ENDERS + 66,
    ENDERS + 114, ENDERS + 74,  nullptr,      ENDERS + 10,  ENDERS + 72,
    nullptr,      ENDERS + 58,  nullptr,      nullptr,      nullptr,
    nullptr,      ENDERS + 8,   ENDERS + 70,  ENDERS + 116, ENDERS + 0,
    ENDERS + 50,  nullptr,      ENDERS + 158, nullptr,      nullptr,
    ENDERS + 173, nullptr,      nullptr,      nullptr,      nullptr,
    nullptr,      nullptr,      nullptr,      nullptr,      nullptr,
    nullptr,      nullptr,      nullptr,      nullptr,      nullptr,
    nullptr,      ENDERS + 65,  nullptr,      ENDERS + 35,  nullptr,
    nullptr,      ENDERS + 163, nullptr,      nullptr,      ENDERS + 63,
    ENDERS + 57,  ENDERS + 97,  ENDERS + 87,  nullptr,      ENDERS + 3,
    nullptr,      nullptr,      nullptr,      nullptr,      nullptr,
    ENDERS + 60,  nullptr,      nullptr,      nullptr,      ENDERS + 83,
    ENDERS + 155, nullptr,      ENDERS + 47,  ENDERS + 150, nullptr,
    nullptr,      nullptr,      ENDERS + 24,  nullptr,      nullptr,
    ENDERS + 28,  nullptr,      nullptr,      ENDERS + 112, nullptr,
    ENDERS + 22,  ENDERS + 130, nullptr,      ENDERS + 26,  nullptr,
    nullptr,      ENDERS + 110, nullptr,      nullptr,      ENDERS + 127,
    nullptr,      nullptr,      nullptr,      nullptr,      nullptr,
    nullptr,      nullptr,      nullptr,      nullptr,      nullptr,
    nullptr,      nullptr,      nullptr,      nullptr,      ENDERS + 93,
    ENDERS + 45,  nullptr,      ENDERS + 141, nullptr,      nullptr,
    ENDERS + 81,  nullptr,      ENDERS + 91,  ENDERS + 43,  ENDERS + 21,
    ENDERS + 139, nullptr,      nullptr,      ENDERS + 79,  nullptr,
    nullptr,      nullptr,      nullptr,      nullptr,      nullptr,
    nullptr,      nullptr,      ENDERS + 129, nullptr,      nullptr,
    ENDERS + 153, nullptr,      ENDERS + 77,  nullptr,      ENDERS + 142,
    ENDERS + 64,  nullptr,      nullptr,      nullptr,      nullptr,
    ENDERS + 162, ENDERS + 34,  nullptr,      ENDERS + 62,  ENDERS + 56,
    nullptr,      nullptr,      nullptr,      ENDERS + 2,   ENDERS + 96,
    ENDERS + 86,  ENDERS + 137, nullptr,      nullptr,      ENDERS + 149,
    ...
    ENDERS + 71,  ENDERS + 117, nullptr,      ENDERS + 9,   nullptr,
    ENDERS + 159, ENDERS + 1,   ENDERS + 51,  nullptr,      ENDERS + 32,
    nullptr,      nullptr,      ENDERS + 190, nullptr,      nullptr,
    ENDERS + 36,  ENDERS + 125, ENDERS + 30,  nullptr,      nullptr,
    ENDERS + 188, ENDERS + 187, nullptr,      ENDERS + 88,  ENDERS + 44,
    nullptr,      nullptr,      ENDERS + 92,  nullptr,      ENDERS + 80,
    ENDERS + 140, nullptr,      ENDERS + 42,  ENDERS + 20,  nullptr,
    ENDERS + 90,  nullptr,      ENDERS + 78,  ENDERS + 138, nullptr,
    ENDERS + 157, nullptr,      nullptr,      ENDERS + 85,  nullptr,
    nullptr,      ENDERS + 49,  nullptr,      nullptr,      nullptr,
    nullptr,      nullptr,      nullptr,      nullptr,      nullptr,
    nullptr,      nullptr,      nullptr,      nullptr,      ENDERS + 25,
    nullptr,      ENDERS + 113, ENDERS + 29,  nullptr,      ENDERS + 131,
...
constexpr JeffPhrasingReverseHashMapEntry REVERSE_ENTRIES[] = {
    ...
    {0x0e3c55fc, 0x0e3c55fc, StenoStroke(0x00000800), 1, 6, 5},
    {0x0e3c55fc, 0x0e3c55fc, StenoStroke(0x00000800), 0, 4, 5},
    ...
    {0x8fbcbc2d, 0x8fbcbc2d, StenoStroke(0x00002000), 1, 4, 9},
    {0x8fbcbc2d, 0x8fbcbc2d, StenoStroke(0x00002000), 0, 6, 9},
    {0x8fbcbc2d, 0x8fbcbc2d, StenoStroke(0x00002000), 0, 4, 10},
