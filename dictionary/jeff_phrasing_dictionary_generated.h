...
constexpr JeffPhrasingReverseHashMapEntry REVERSE_ENTRIES[] = {
    ...
    {0x06aa82f6, 0x8707b2d8, StenoStroke(0x00294000), 0, 8, 3},
    ...
    {0x08f0effc, 0x8707b2d8, StenoStroke(0x00454000), 0, 8, 3},
    {0x08f0effc, 0x8707b2d8, StenoStroke(0x00654000), 0, 8, 11},
    {0x0966a6ff, 0x8707b2d8, StenoStroke(0x000e0000), 0, 8, 3},
    {0x0966a6ff, 0x8707b2d8, StenoStroke(0x002e0000), 0, 8, 11},
    {0x0a817e37, 0x8707b2d8, StenoStroke(0x0010c000), 1, 8, 3},
    ...
    {0x0ce50045, 0x8707b2d8, StenoStroke(0x00540000), 0, 8, 3},
    {0x0ceb84c6, 0x8707b2d8, StenoStroke(0x00460000), 0, 8, 7},
    {0x0ceb84c6, 0x8707b2d8, StenoStroke(0x00660000), 0, 8, 3},
    {0x0d2db8f0, 0x8707b2d8, StenoStroke(0x00014000), 0, 8, 3},
    {0x0d2db8f0, 0x8707b2d8, StenoStroke(0x00214000), 0, 8, 11},
    {0x0daeceeb, 0x8707b2d8, StenoStroke(0x00124000), 1, 8, 7},
    {0x0daeceeb, 0x8707b2d8, StenoStroke(0x00524000), 0, 8, 3},
    ...
    {0x17b46a1f, 0x8707b2d8, StenoStroke(0x002b8000), 0, 8, 3},
    {0x1830eda6, 0x8707b2d8, StenoStroke(0x000f0000), 0, 8, 7},
    {0x19a74354, 0x8707b2d8, StenoStroke(0x00158000), 0, 8, 7},
    {0x19a74354, 0x8707b2d8, StenoStroke(0x00558000), 0, 8, 3},
    ...
    {0x1a834993, 0x8707b2d8, StenoStroke(0x00024000), 0, 8, 3},
    ...
    {0x1aeec2c5, 0x8707b2d8, StenoStroke(0x002dc000), 0, 8, 3},
    ...
    {0x1b501b4e, 0x8707b2d8, StenoStroke(0x002f0000), 0, 8, 3},
    ...
    {0x1d82eb26, 0x8707b2d8, StenoStroke(0x0025c000), 0, 8, 3},
    {0x1d8f9346, 0x0609009d, StenoStroke(0x000000e2), 0, 2, 14},
    {0x1d90eeb5, 0x8707b2d8, StenoStroke(0x0001c000), 1, 8, 3},
    ...
    {0x1e151309, 0x8707b2d8, StenoStroke(0x00084000), 1, 8, 3},
    ...
    {0x1f3c70ad, 0x8707b2d8, StenoStroke(0x00608000), 0, 8, 3},
    {0x1f522e50, 0x8707b2d8, StenoStroke(0x00030000), 1, 8, 7},
    {0x1f522e50, 0x8707b2d8, StenoStroke(0x00230000), 0, 8, 3},
    ...
    {0x2273d1a5, 0x8707b2d8, StenoStroke(0x0023c000), 0, 8, 3},
    ...
    {0x266fa23b, 0x8707b2d8, StenoStroke(0x00614000), 0, 8, 3},
    {0x26aefbc0, 0x8707b2d8, StenoStroke(0x00180000), 0, 8, 7},
    {0x27684180, 0x8707b2d8, StenoStroke(0x00190000), 0, 8, 7},
    {0x27684180, 0x8707b2d8, StenoStroke(0x00790000), 0, 8, 3},
    ...
    {0x28ec173f, 0x8707b2d8, StenoStroke(0x002d8000), 0, 8, 3},
    {0x29ee350f, 0x8707b2d8, StenoStroke(0x0012c000), 0, 8, 7},
    {0x2a028ff0, 0x0609009d, StenoStroke(0x00000362), 0, 2, 14},
    ...
    {0x2f21896f, 0x8707b2d8, StenoStroke(0x00204000), 0, 8, 3},
    ...
    {0x3568a8c0, 0x8707b2d8, StenoStroke(0x00604000), 0, 8, 3},
    ...
    {0x386f360b, 0x8707b2d8, StenoStroke(0x0028c000), 0, 8, 3},
    ...
    {0x3cb73648, 0x8707b2d8, StenoStroke(0x000ac000), 0, 8, 3},
    ...
    {0x3f30e086, 0x8707b2d8, StenoStroke(0x00628000), 0, 8, 3},
    {0x3f31f002, 0x8707b2d8, StenoStroke(0x00038000), 1, 8, 7},
    {0x3f31f002, 0x8707b2d8, StenoStroke(0x00238000), 0, 8, 3},
    ...
    {0x44ac63b8, 0x8707b2d8, StenoStroke(0x00090000), 0, 8, 3},
    ...
    {0x456239f9, 0x8707b2d8, StenoStroke(0x00268000), 0, 8, 3},
    {0x46224440, 0x8707b2d8, StenoStroke(0x00454000), 0, 8, 7},
    {0x46224440, 0x8707b2d8, StenoStroke(0x00654000), 0, 8, 3},
    {0x4686967c, 0x8707b2d8, StenoStroke(0x00010000), 1, 8, 7},
    {0x4686967c, 0x8707b2d8, StenoStroke(0x00210000), 0, 8, 3},
    ...
    {0x4cf73ae2, 0x8707b2d8, StenoStroke(0x00010000), 1, 8, 3},
    ...
    {0x4f91d53c, 0x8707b2d8, StenoStroke(0x00214000), 0, 8, 3},
    {0x5060b8c4, 0x8707b2d8, StenoStroke(0x00148000), 1, 8, 3},
    ...
    {0x508edb76, 0x8707b2d8, StenoStroke(0x00078000), 1, 8, 3},
    ...
    {0x52b1c121, 0x8707b2d8, StenoStroke(0x00184000), 0, 8, 3},
    ...
    {0x5468790f, 0x8707b2d8, StenoStroke(0x002b0000), 0, 8, 3},
    ...
    {0x57f87174, 0x8707b2d8, StenoStroke(0x00138000), 0, 8, 3},
    {0x57f87174, 0x8707b2d8, StenoStroke(0x00538000), 0, 8, 11},
    {0x5823daa0, 0x8707b2d8, StenoStroke(0x000f8000), 0, 8, 3},
    {0x5823daa0, 0x8707b2d8, StenoStroke(0x002f8000), 0, 8, 11},
    {0x58a6ad82, 0x8707b2d8, StenoStroke(0x000b8000), 0, 8, 3},
    ...
    {0x5b754b18, 0x8707b2d8, StenoStroke(0x0018c000), 0, 8, 3},
    ...
    {0x5d9a8b18, 0x8707b2d8, StenoStroke(0x007a0000), 0, 8, 3},
    {0x5edc26af, 0x8707b2d8, StenoStroke(0x00114000), 1, 8, 3},
    ...
    {0x605afb1e, 0x8707b2d8, StenoStroke(0x00288000), 0, 8, 3},
    ...
    {0x6156e822, 0x8707b2d8, StenoStroke(0x002d0000), 0, 8, 3},
    {0x62bfcab3, 0x8707b2d8, StenoStroke(0x000a0000), 1, 8, 7},
    {0x62bfcab3, 0x8707b2d8, StenoStroke(0x002a0000), 0, 8, 3},
    ...
    {0x64e2a26f, 0x8707b2d8, StenoStroke(0x0021c000), 0, 8, 3},
    ...
    {0x6b660a33, 0x8707b2d8, StenoStroke(0x00054000), 1, 8, 3},
    ...
    {0x7d5bd382, 0x8707b2d8, StenoStroke(0x00048000), 1, 8, 3},
    ...
    {0x82225168, 0x8707b2d8, StenoStroke(0x00250000), 0, 8, 3},
    ...
    {0x8b4ba9e6, 0x8707b2d8, StenoStroke(0x000c8000), 0, 8, 3},
    ...
    {0x9350acf9, 0x8707b2d8, StenoStroke(0x00780000), 0, 8, 3},
    ...
    {0x94e4ac3b, 0x8707b2d8, StenoStroke(0x0024c000), 0, 8, 3},
    {0x95989bc5, 0x8707b2d8, StenoStroke(0x000c8000), 0, 8, 7},
    {0x96445b9d, 0x8707b2d8, StenoStroke(0x000d8000), 0, 8, 3},
    ...
    {0x9b3d4b2f, 0x8707b2d8, StenoStroke(0x00224000), 0, 8, 3},
    {0x9b71cf23, 0x8707b2d8, StenoStroke(0x001a8000), 0, 8, 7},
    {0x9b71cf23, 0x8707b2d8, StenoStroke(0x007a8000), 0, 8, 3},
    ...
    {0x9c428b46, 0x8707b2d8, StenoStroke(0x00794000), 0, 8, 3},
    ...
    {0x9f370ce5, 0x8707b2d8, StenoStroke(0x0022c000), 0, 8, 3},
    {0x9f3fe7fd, 0x8707b2d8, StenoStroke(0x000c4000), 0, 8, 7},
    {0x9f74b898, 0x8707b2d8, StenoStroke(0x00130000), 0, 8, 7},
    {0x9f74b898, 0x8707b2d8, StenoStroke(0x00530000), 0, 8, 3},
    {0x9f7fae07, 0x8707b2d8, StenoStroke(0x00184000), 0, 8, 7},
    {0x9fee2525, 0x8707b2d8, StenoStroke(0x000a4000), 0, 8, 7},
    {0x9fee2525, 0x8707b2d8, StenoStroke(0x002a4000), 0, 8, 3},
    {0xa0047729, 0x8707b2d8, StenoStroke(0x00020000), 0, 8, 3},
    ...
    {0xa3f33dfa, 0x8707b2d8, StenoStroke(0x00458000), 0, 8, 3},
    {0xa3f33dfa, 0x8707b2d8, StenoStroke(0x00658000), 0, 8, 11},
    {0xa407938f, 0x8707b2d8, StenoStroke(0x00018000), 1, 8, 7},
    {0xa407938f, 0x8707b2d8, StenoStroke(0x00218000), 0, 8, 3},
    {0xa4520a18, 0x8707b2d8, StenoStroke(0x00100000), 0, 8, 3},
    ...
    {0xa5126bcf, 0x8707b2d8, StenoStroke(0x000e8000), 0, 8, 3},
    {0xa5126bcf, 0x8707b2d8, StenoStroke(0x002e8000), 0, 8, 11},
    {0xa51e47cc, 0x8707b2d8, StenoStroke(0x00138000), 0, 8, 7},
    {0xa51e47cc, 0x8707b2d8, StenoStroke(0x00538000), 0, 8, 3},
    {0xa5f91580, 0x8707b2d8, StenoStroke(0x00408000), 0, 8, 3},
    {0xa5f91580, 0x8707b2d8, StenoStroke(0x00608000), 0, 8, 11},
    {0xa606c573, 0x8707b2d8, StenoStroke(0x00074000), 0, 8, 7},
    {0xa606c573, 0x8707b2d8, StenoStroke(0x00274000), 0, 8, 3},
    {0xa67b83b8, 0x8707b2d8, StenoStroke(0x0000c000), 1, 8, 7},
    {0xa67b83b8, 0x8707b2d8, StenoStroke(0x0020c000), 0, 8, 3},
    {0xa6a43c1b, 0xa6a43c1b, StenoStroke(0x00001000), 0, 4, 13},
    {0xa6a43c1b, 0xa6a43c1b, StenoStroke(0x00001400), 0, 4, 13},
    ...
    {0xa7191336, 0x8707b2d8, StenoStroke(0x00278000), 0, 8, 3},
    ...
    {0xa9eb7789, 0x8707b2d8, StenoStroke(0x0052c000), 0, 8, 3},
    ...
    {0xad4aa09e, 0x8707b2d8, StenoStroke(0x00508000), 0, 8, 3},
    {0xae36585c, 0x8707b2d8, StenoStroke(0x000c0000), 0, 8, 3},
    ...
    {0xafeae2a7, 0x8707b2d8, StenoStroke(0x00658000), 0, 8, 3},
    {0xb0339683, 0x8707b2d8, StenoStroke(0x00020000), 0, 8, 7},
    {0xb0339683, 0x8707b2d8, StenoStroke(0x00220000), 0, 8, 3},
    {0xb04be33a, 0x8707b2d8, StenoStroke(0x000f8000), 0, 8, 7},
    {0xb0fa6411, 0x8707b2d8, StenoStroke(0x00044000), 1, 8, 3},
    ...
    {0xb41668c7, 0x8707b2d8, StenoStroke(0x00514000), 0, 8, 3},
    ...
    {0xb8cb2493, 0x8707b2d8, StenoStroke(0x001c8000), 0, 8, 3},
    ...
    {0xba745a27, 0x8707b2d8, StenoStroke(0x00140000), 1, 8, 3},
    ...
    {0xbfe8d608, 0x8707b2d8, StenoStroke(0x00094000), 0, 8, 3},
    {0xbfe8d608, 0x8707b2d8, StenoStroke(0x00294000), 0, 8, 11},
    {0xc11afc41, 0x8707b2d8, StenoStroke(0x00104000), 0, 8, 7},
    {0xc11afc41, 0x8707b2d8, StenoStroke(0x00504000), 0, 8, 3},
    {0xc1389bb2, 0x8707b2d8, StenoStroke(0x001a0000), 0, 8, 3},
    ...
    {0xc3551be2, 0x8707b2d8, StenoStroke(0x00244000), 0, 8, 3},
    {0xc39d69da, 0x8707b2d8, StenoStroke(0x0004c000), 1, 8, 3},
    {0xc39d69da, 0x8707b2d8, StenoStroke(0x0024c000), 0, 8, 11},
    {0xc3e99418, 0x8707b2d8, StenoStroke(0x000c0000), 0, 8, 7},
    {0xc3e99418, 0x8707b2d8, StenoStroke(0x002c0000), 0, 8, 3},
    ...
    {0xc6ec8df5, 0x8707b2d8, StenoStroke(0x00428000), 0, 8, 3},
    ...
    {0xca19cbba, 0x8707b2d8, StenoStroke(0x00070000), 1, 8, 3},
    {0xca19cbba, 0x8707b2d8, StenoStroke(0x00270000), 0, 8, 11},
    {0xcba7e880, 0x8707b2d8, StenoStroke(0x00030000), 1, 8, 3},
    {0xcba7e880, 0x8707b2d8, StenoStroke(0x00230000), 0, 8, 11},
    {0xcbe29615, 0x8707b2d8, StenoStroke(0x0002c000), 1, 8, 3},
    ...
    {0xcc2b13c3, 0x8707b2d8, StenoStroke(0x002d4000), 0, 8, 3},
    {0xcc4cef0e, 0x8707b2d8, StenoStroke(0x000bc000), 0, 8, 7},
    {0xcc4cef0e, 0x8707b2d8, StenoStroke(0x002bc000), 0, 8, 3},
    ...
    {0xcf05a4c2, 0x8707b2d8, StenoStroke(0x0051c000), 0, 8, 3},
    {0xcf401f72, 0xcf401f72, StenoStroke(0x00003c00), 0, 4, 13},
    {0xcfcd5811, 0x8707b2d8, StenoStroke(0x00194000), 0, 8, 3},
    ...
    {0xd0cdcf54, 0x8707b2d8, StenoStroke(0x00280000), 0, 8, 3},
    ...
    {0xd27eea40, 0xd27eea40, StenoStroke(0x00002000), 1, 6, 5},
    {0xd27eea40, 0xd27eea40, StenoStroke(0x00002000), 0, 4, 15},
    ...
    {0xd5fe8280, 0x8707b2d8, StenoStroke(0x000f0000), 0, 8, 3},
    ...
    {0xdafa51be, 0x8707b2d8, StenoStroke(0x00208000), 0, 8, 3},
    {0xdb36efc7, 0x8707b2d8, StenoStroke(0x000e0000), 0, 8, 7},
    {0xdb36efc7, 0x8707b2d8, StenoStroke(0x002e0000), 0, 8, 3},
    {0xdbb7ef0c, 0x8707b2d8, StenoStroke(0x000dc000), 0, 8, 7},
    {0xdbfaf0b0, 0x8707b2d8, StenoStroke(0x00084000), 1, 8, 7},
    {0xdbfaf0b0, 0x8707b2d8, StenoStroke(0x00284000), 0, 8, 3},
    {0xdcb980a8, 0x8707b2d8, StenoStroke(0x000cc000), 0, 8, 7},
    {0xdcb980a8, 0x8707b2d8, StenoStroke(0x002cc000), 0, 8, 3},
    ...
    {0xdd5c9ea2, 0x8707b2d8, StenoStroke(0x0029c000), 0, 8, 3},
    {0xdd72bca0, 0x8707b2d8, StenoStroke(0x000c8000), 0, 8, 7},
    {0xdd72bca0, 0x8707b2d8, StenoStroke(0x002c8000), 0, 8, 3},
    {0xdd939ce8, 0x8707b2d8, StenoStroke(0x00098000), 0, 8, 7},
    {0xdd939ce8, 0x8707b2d8, StenoStroke(0x00298000), 0, 8, 3},
    {0xddd85bbd, 0x8707b2d8, StenoStroke(0x00184000), 0, 8, 7},
    {0xddd85bbd, 0x8707b2d8, StenoStroke(0x00784000), 0, 8, 3},
    ...
    {0xefe51ebf, 0x8707b2d8, StenoStroke(0x00528000), 0, 8, 3},
    {0xf0c1c06e, 0x8707b2d8, StenoStroke(0x001a4000), 0, 8, 3},
    ...
    {0xf3eb085e, 0x8707b2d8, StenoStroke(0x002ac000), 0, 8, 3},
    {0xf46c3323, 0x8707b2d8, StenoStroke(0x00060000), 1, 8, 7},
    {0xf46c3323, 0x8707b2d8, StenoStroke(0x00260000), 0, 8, 3},
    {0xf493ff29, 0x8707b2d8, StenoStroke(0x000bc000), 0, 8, 3},
    ...
    {0xfe6f5a7e, 0x8707b2d8, StenoStroke(0x00068000), 1, 8, 3},
...
constexpr JeffPhrasingReverseStructureEntry REVERSE_STRUCTURES[] = {
    ...
    {0xa4c31f9b, StenoStroke(0x00001000), 13},
