...
constexpr KeyCodeName KEYS[] = {
    ...
    {"brightness_down", KeyCode::CONSUMER_PAGE_BRIGHTNESS_DOWN},
    {"brightness_up", KeyCode::CONSUMER_PAGE_BRIGHTNESS_UP},
    {"c", KeyCode::C},
    ...
    {"f9", KeyCode::F9},
    {"find", KeyCode::FIND},
    {"fn", KeyCode::CONSUMER_PAGE_FN_GLOBE},
    {"g", KeyCode::G},
    {"globe", KeyCode::CONSUMER_PAGE_FN_GLOBE},
    {"grave", KeyCode::GRAVE},
    {"greater", KeyCode::DOT},
    {"h", KeyCode::H},
    ...
    {"mute", KeyCode::CONSUMER_PAGE_MUTE},
    {"n", KeyCode::N},
    {"o", KeyCode::O},
    {"open", KeyCode::OPEN},
    {"p", KeyCode::P},
    ...
    {"up", KeyCode::UP},
    {"v", KeyCode::V},
    {"volume_down", KeyCode::CONSUMER_PAGE_VOLUME_DOWN},
    {"volume_up", KeyCode::CONSUMER_PAGE_VOLUME_UP},
    {"w", KeyCode::W},
