...
constexpr KeyCodeName KEYS[] = {
    ...
    {"copy", KeyCode::COPY},
    {"currency_sub_unit", KeyCode::CURRENCY_SUB_UNIT},
    {"currency_unit", KeyCode::CURRENCY_UNIT},
    {"cut", KeyCode::CUT},
    {"d", KeyCode::D},
    ...
    {"kp_clear_entry", KeyCode::KP_CLEAR_ENTRY},
    ...
    {"kp_plus_minus", KeyCode::KP_PLUS_MINUS},
    ...
    {"less", KeyCode::COMMA},
    {"m", KeyCode::M},
    {"media_back", KeyCode::MEDIA_BACK},
    {"media_calculator", KeyCode::MEDIA_CALCULATOR},
    {"media_coffee", KeyCode::MEDIA_COFFEE},
    {"media_edit", KeyCode::MEDIA_EDIT},
    {"media_eject_cd", KeyCode::MEDIA_EJECT_CD},
    {"media_find", KeyCode::MEDIA_FIND},
    {"media_forward", KeyCode::MEDIA_FORWARD},
    {"media_mute", KeyCode::MEDIA_MUTE},
    {"media_next_song", KeyCode::MEDIA_NEXT_SONG},
    {"media_play_pause", KeyCode::MEDIA_PLAY_PAUSE},
    {"media_previous_song", KeyCode::MEDIA_PREVIOUS_SONG},
    {"media_refresh", KeyCode::MEDIA_REFRESH},
    {"media_scroll_down", KeyCode::MEDIA_SCROLL_DOWN},
    {"media_scroll_up", KeyCode::MEDIA_SCROLL_UP},
    {"media_sleep", KeyCode::MEDIA_SLEEP},
    {"media_stop", KeyCode::MEDIA_STOP},
    {"media_stop_cd", KeyCode::MEDIA_STOP_CD},
    {"media_volume_down", KeyCode::MEDIA_VOLUME_DOWN},
    {"media_volume_up", KeyCode::MEDIA_VOLUME_UP},
    {"media_www", KeyCode::MEDIA_WWW},
    {"menu", KeyCode::MENU},
    {"meta", KeyCode::L_META},
